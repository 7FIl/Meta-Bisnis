...
export default function OnboardingView({ user, onConsultAI, onSetupComplete, businessData, loading }) {
    ...
    const [selectedSide, setSelectedSide] = useState(null); // 'ai' | 'manual' | null
    ...
    const handleManualSetup = async (e) => {
        e.preventDefault();
        // Loading state dikelola di parent (page.js) melalui prop 'loading'
    ...
    const handleAIConsult = async () => {
        ...
        try {
            ...
            // Parameter ketiga 'true' menunjukkan asal dari onboarding.
                    ...
                    <div className="p-8 space-y-6 flex flex-col">
                        <div className="flex items-center justify-between border-b pb-4">
                            <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
                                <i className="fas fa-lightbulb text-blue-500"></i> Ide Bisnis dari AI
                            </h2>
