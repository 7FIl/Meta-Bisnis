  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 lg:col-span-1 h-fit">
      ...
      <div className="bg-slate-50 rounded-xl p-4 mb-6 border border-slate-100">
        <p className="text-xs text-slate-500 uppercase font-semibold">Saldo Saat Ini</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full text-sm p-2 border border-slate-300 rounded-lg focus:ring-1 focus:ring-blue-500 outline-none"
          />
        </div>
        <div className="flex gap-2">
          ...
          <div className="w-1/3">
            ...
            <select
              ...
              className="w-full text-sm p-2 border border-slate-300 rounded-lg outline-none bg-white"
            >
        ...
        <button
          type="submit"
          className="w-full bg-slate-800 hover:bg-slate-900 text-white py-2 rounded-lg text-sm font-medium transition-colors"
        >
          Catat Transaksi
        </button>
      </form>
        ...
        <ul className="space-y-2 text-sm max-h-40 overflow-y-auto pr-1">
          {transactions.length === 0 ? (
            ...
            transactions.map((t) => (
              ...
              >
                <span className="text-slate-700 truncate w-1/2">{t.desc}</span>
                <span
                  className={`font-bold ${
